      ...
      <div className="w-full max-w-sm">
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8 shadow-[var(--shadow-md)]">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-[var(--muted-foreground)] mt-1">Sign in to manage your relay nodes</p>
          </div>
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-sm font-medium text-[var(--muted-foreground)] mb-2" htmlFor="password">
                Password
              </label>
              <input
                id="password"
