              ...
              <tbody className="divide-y divide-[var(--border)]">
                {nodes.map((node) => (
                  <tr key={node.id}>
                    ...
                    <td className="px-5 py-4">
                      {node.groupId ? (
                        <span className="px-2 py-1 bg-[var(--muted)] rounded text-xs">
                          {groups.find((g) => g.id === node.groupId)?.name || "—"}
                        </span>
                      ) : (
                    ...
                    <td className="px-5 py-4">
                      <span
                        className={`inline-flex items-center gap-1.5 text-xs font-medium ${node.status === "online" ? "text-[var(--success)]" : "text-[var(--muted-foreground)]"}`}
                      >
                        <span
                    ...
                    <td className="px-5 py-4 font-mono text-xs text-[var(--muted-foreground)]">
                ...
                {nodes.length === 0 && (
                  <tr>
                    <td
                      colSpan={7}
                      className="px-5 py-12 text-center text-[var(--muted-foreground)]"
                    >
