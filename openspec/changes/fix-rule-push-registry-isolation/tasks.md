...
- [ ] 2.2 Remove the temporary log after confirming the fix works.

## 3. Validate catch-up sync still works

- [ ] 3.1 Disconnect an agent, add a rule via the dashboard, reconnect the agent, and verify it receives the catch-up event and applies the rule.
